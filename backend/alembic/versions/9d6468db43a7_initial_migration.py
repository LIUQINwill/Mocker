...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("response_status_code", sa.Integer(), nullable=True, comment="响应状态码", default=200),
        sa.Column("response_headers", sa.JSON(), nullable=True, comment="响应头"),
        sa.Column("is_active", sa.Boolean(), nullable=True, comment="是否启用", default=True),
        sa.Column("delay_ms", sa.Integer(), nullable=True, comment="响应延迟(毫秒)", default=0),
